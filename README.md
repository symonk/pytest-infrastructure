...
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=symonk_pytest-validate:wq&metric=bugs)](https://sonarcloud.io/dashboard?id=symonk_pytest-validate)
